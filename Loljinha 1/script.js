...
function adicionarItem(id) {
  var produto = {
    id: id,
    nome: "Produto " + id,
    preco: id == 1 ? 16 : id == 2 ? 121 : 151 // exemplo com três produtos
  };
...
function atualizarCarrinho() {
  ...
  if (!carrinhoElemento) return; // sair da função caso o elemento não exista
  ...
  if (!valorTotalElemento) return; // sair da função caso o elemento não exista
